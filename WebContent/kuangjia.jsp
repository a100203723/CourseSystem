...
<frameset rows="20%,*" cols="*" frameborder="no" border="0" framespacing="0">
  ...
  <frameset rows="*" cols="10%,*" framespacing="0" frameborder="no" border="0">
    <frame src="leftFrame.jsp" name="leftFrame" scrolling="no" noresize="noresize" id="leftFrame" title="leftFrame" />
    <frame src="zhuye.jsp" name="mainFrame" id="mainFrame" title="mainFrame" />
  </frameset>
</frameset>
<noframes>
<body>
